...
Classified_Vehicle::Classified_Vehicle(std::string aPrice, std::string aCity, std::string aContactNo, std::string details, std::string aUrl, std::chrono::year_month_day aDate, std::string aMake, std::string aModel, 
	int aYoM, int aMileage, std::string aTransmission, std::string aFuelType, std::string aType, std::string aStartType, std::string options, int anEngineCapacity)
	...
	myType(aType), myStartType(aStartType), myOptions(options), myEngineCapacity(anEngineCapacity)
{
}
